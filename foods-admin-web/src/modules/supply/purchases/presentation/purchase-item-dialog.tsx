        ...
        <div className="purchase-item-body">
          ...
          {mode==="existing"?<section className="purchase-item-section purchase-existing-section">
            ...
            <label className="purchase-existing-search">Artículo
              <span className="purchase-search-field"><Icon name="search" size={16}/><Input autoFocus value={search} onChange={event=>setSearch(event.target.value)} placeholder="Escribe el nombre del producto o insumo"/></span>
            </label>
