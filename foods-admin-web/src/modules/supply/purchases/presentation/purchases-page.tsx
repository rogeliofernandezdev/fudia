...
function PurchaseDetail({order,canManage,canReceive,busy,currency,country,timezone,close,edit,changeStatus,receive,cancel}:{order:PurchaseOrder;canManage:boolean;canReceive:boolean;busy:boolean;currency:string;country?:string|null;timezone?:string|null;close:()=>void;edit:()=>void;changeStatus:(next:"draft"|"pending_approval"|"approved"|"cancelled")=>void;receive:()=>void;cancel:()=>void}){
