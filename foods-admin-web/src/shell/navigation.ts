...
export const navigationGroups:NavGroup[]=[
 ...
 {label:"INTELIGENCIA",items:[{href:"/costos",name:"Gastos",icon:"stock",module:"costos",permission:"expenses.read"},{href:"/bi",name:"Restaurant BI",icon:"grid",module:"bi"},{href:"/app-manager",name:"App manager",icon:"settings",module:"app_manager"}]},
