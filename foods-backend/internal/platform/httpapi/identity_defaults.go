...
var defaultOrganizationRoles = []organizationRoleSeed{
	...
	{Name:"Mesero",SystemKey:"waiter",Description:"Gestiona mesas, clientes, pedidos y reservas",MenuAccess:[]string{"pos","pedidos","mesas","reservas"},Permissions:[]string{"menu.read","customers.read","customers.manage","orders.read","orders.manage","tables.read","reservations.read","reservations.manage"}},
