...
var permissionCatalog = []map[string]any{
	...
	{"group": "Operación", "items": []map[string]string{{"value": "orders.read", "label": "Ver pedidos y comandas"}, {"value": "orders.manage", "label": "Gestionar pedidos"}, {"value": "kitchen.manage", "label": "Actualizar comandas"}, {"value": "tables.read", "label": "Ver mesas"}, {"value": "tables.manage", "label": "Administrar mesas"}, {"value": "cash.read", "label": "Ver caja"}, {"value": "cash.manage", "label": "Operar caja"}, {"value": "receipts.read", "label": "Ver comprobantes"}, {"value": "receipts.manage", "label": "Emitir comprobantes"}}},
